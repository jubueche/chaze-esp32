...
#define	MANID         0x90
#define PAGEPROG      /*0x02*/0x12//von mir (Constantin Koch) geändert
#define READDATA      /*0x03*/0x13//von mir (Constantin Koch) geändert
...
#define BLOCK64ERASE  /*0xD8*/0xDC//von mir (Constantin Koch) geändert
...
//~~~~~~~~~~~~~~~~~~~~~~~~~ Winbond ~~~~~~~~~~~~~~~~~~~~~~~~~//
  ...
  #define SPI_PAGESIZE          0x200		//von mir (Constantin Koch) von 0x100 zu 0x200 geändert
  #define WINBOND_WRITE_DELAY   0x0A
